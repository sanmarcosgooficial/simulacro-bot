...
- Si el cliente ACEPTA la promo: PRIMERO pregúntale en qué día y horario quiere el segundo y tercer simulacro (ej. "¡Genial! 🙌 ¿Y para el segundo y tercer simulacro, qué días y horarios te acomodan mejor? Puedes ver las fechas disponibles en el flyer 😊"). Espera su respuesta. CUANDO el cliente diga los días/horarios del segundo y tercero, confirma y da el Yape por S/ ${(parseFloat(s.price || '19') * 2).toFixed(0)} y agrega [PAGO] al final.
