...
- Cómo califica el examen de admisión San Marcos (DECO): el examen tiene 100 preguntas de opción múltiple. Cada respuesta correcta suma 4 puntos, cada respuesta incorrecta resta 1 punto, y las preguntas en blanco no suman ni restan. El puntaje máximo es 400 puntos. Las preguntas están divididas por áreas académicas según la carrera a la que postula. Si el cliente pregunta cómo califica o cómo funciona el puntaje, explícalo brevemente y menciona que en el simulacro verá exactamente ese mismo sistema de puntaje.
